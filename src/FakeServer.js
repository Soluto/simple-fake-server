...
export default class FakeServer {
  ...
  start () {
    ...
    app.use(function* () { // eslint-disable-line require-yield
      const matched = self.mockedCalls.filter(call => {
    ...
    this.server = !this.tls ? app.listen(this.port || 1111) : https.createServer(selfSignedCertificate, app.callback()).listen(this.port || 1111);
  }
